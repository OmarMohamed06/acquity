...
export default function FilteredInvestmentsPage() {
  ...
  useEffect(() => {
    ...
    const fetchListings = async () => {
      try {
        console.log(
          "Fetching investment_opportunity listings from Supabase...",
        );
        ...
        const parsed: Listing[] = data.map((listing: any) => {
          ...
          const details = listing.investment_opportunity_details;
  ...
  const getPageTitle = () => {
    if (currentIndustry && currentCountry) {
      return `${currentIndustry} Investments in ${currentCountry}`;
    }
    if (currentIndustry) {
      return `${currentIndustry} Investment Opportunities`;
    }
    if (currentCountry) {
      return `Investment Opportunities in ${currentCountry}`;
    }
          ...
          >
            <div className="flex flex-col gap-1 md:gap-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm md:text-base">
                Explore promising investment opportunities globally.
              </p>
            </div>
